...
/**************************Part1 ch: SDK   ʼ   | en: SDK Initialization ******************************************/
...
/**************************Part2 ch:     Ŀ  ƺ ȡ    | en: Camera control and streaming******************************************/
 ...
 *  @param  handle                      [IN]             豸   
 *  @param  hWnd                        [IN]               ھ  
 *  @param  pstImage                    [IN]            ͼ    Ϣ
 *  @param  enRenderMode                [IN]              Ⱦ  ʽ  Windows:0-GDI 1-D3D 2-OpenGL Linux:0-OpenGL       
 *  @return  ɹ       MV_OK     󣬷  ش     
 *  @remarks   ѡ  OpenGL  Ⱦģʽ  ֧  PixelType_Gvsp_RGB8_Packed  PixelType_Gvsp_BGR8_Packed  PixelType_Gvsp_Mono8       ظ ʽͼ   С    4GB    Ⱦ        Ⱦģʽ  ֧ ֡ 
               ͼ   Сδ    4GB  ֧ ֿ ߴ С  int    
                 ʱ  Ҫ    MV_CC_IMAGE ṹ    nImageLen  ֵ
			   ȾģʽΪD3Dʱ  ֧ ֵ    ֱ   Ϊ16384 * 163840
 ...
 *  @remarks    øýӿڿ       SDK ڲ ͼ 񻺴 ڵ       ڵ   MV_CC_StartGrabbing  ʼץͼǰ   á 
             ...
             SDKʵ ʷ   Ľڵ     = SDK ڲ Ԥ    ĸ    +  û     Ľڵ (MV_CC_SetImageNodeNum);  ϵͳ ڴ   Դ    ,SDK ڲ      ¼   ,      ¼   Ľڵ    Ϊ׼
              ýӿڲ ֧  MV_CAMERALINK_DEVICE    ͵  豸  
 ...
 *  @remarks  ýӿڶ         ȡ     ԣ  û    Ը   ʵ         ѡ 񡣾          £ 
                ...
                UpcomingImage:       ڵ   ȡ   ӿ ʱ            б       ͼ 񣬲  ȴ  豸       ɵ һ֡ͼ 񡣣  ò  Բ ֧  MV_USB_DEVICE 豸  
              ýӿ   Windowsƽ̨  ֧  MV_GIGE_DEVICE  MV_USB_DEVICE 豸    Linuxƽ̨  ֧  MV_USB_DEVICE 豸  
...
/**************************Part3 ch:  ɼ           | en: Frame grabber control ******************************************/

/********************************************************************//**
*  @~chinese
*  @brief   ö ٲɼ   
*  @param   nTLayerType        [IN]              ɼ    ӿ      eg: (MV_GIGE_INTERFACE | MV_CAMERALINK_INTERFACE | MV_CXP_INTERFACE| MV_XOF_INTERFACE | MV_VIR_INTERFACE  
...
*  @param  pstEnumValue                [IN][OUT]          ظ        й  豸   Խṹ  ָ  
*  @return  ɹ ,    MV_OK,ʧ  ,   ش     
*  @remarks      豸֮    øýӿڿ  Ի ȡEnum   ͵ ָ   ڵ  ֵ,      MV_CC_GetEnumValue, ˽ӿڷ  ص ö    Ч      չ  256    
...
/*******************Part5 ch:     Ͳɼ         | en:  Camera /Frame grabber  upgrade *******************/
...
/*******************Part7 ch:   GigE 豸֧ ֵĽӿ  | en: Only support GigE interface*******************/
 ...
 *  @brief      GVSPȡ    ʱʱ  
 *  @param  handle                      [IN]             豸   
 *  @param  nMillisec                   [IN]              ʱʱ 䣬Ĭ  300ms    Χ:[10 - UINT_MAX)
 *  @return  ɹ       MV_OK     󣬷  ش      
...
/*******************Part10 ch: GenTL  ؽӿ  | en: GenTL related interface*******************/
...
/*******************Part11 ch: ͼ 񱣴桢  ʽת      ؽӿ  | en: Related image save and format convert interface*******************/
 ...
 *  @param  handle                      [IN]             豸   
 *  @param  pstImage                    [IN]            ͼ    Ϣ
 *  @param  pSaveImageParam             [IN]              ͼ    
 *  @param  pcImagePath                 [IN]              ͼ·  
 *  @return  ɹ       MV_OK     󣬷  ش      
 *  @remarks  ýӿ ֧  4G   ϳ   ͼ  PNG/TIFF  ͼ   ǳ   ͼ  ֧  BMP/JPEG/TIFF/PNG
			 JPEG  ʽ   ֧ ֿ  Ϊ65500
 *  @~english
 *  @brief  Save the image file.
 *  @param  handle                      [IN]            Device handle
 ...
 *  @brief  ͼ  ȥ ϱ 
 *  @param  handle                      [IN]             豸   
 *  @param  pstPurpleFringingParam      [IN][OUT]       ȥ ϱ߲   
 *  @return  ɹ       MV_OK     󣬷  ش      
 *  @remarks    ظ ʽ  ֧  PixelType_Gvsp_RGB8_Packed  PixelType_Gvsp_BGR8_Packed
 ...
 *  @brief    ͼ     ISP 㷨    
 *  @param  handle                      [IN]             豸   
 *  @param  pstInputImage               [IN]                ͼ  ṹ  
 *  @param  pstOutputImage              [IN][OUT]          ͼ  ṹ  
 *  @return  ɹ       MV_OK     󣬷  ش     
 *  @remarks   Ҫ ȵ   MV_CC_SetISPConfig         ļ ,      ļ   ISP        
...
*  @remarks     ʹ   MV_CC_GetPayloadSize   ȡ     С    ʹ   MV_CC_AllocAlignedBuffer     ռ䣬֮     MV_CC_RegisterBufferע  
            ...
            ˫USB ӿ    Ҫ      ע  3  ռ䵽SDK ڲ ;              ƣ     Ϊ ˱  ⻺ 治 㣬       㹻 Ļ  浽 ײ 
*  @~english
